    ...
    def _process_cot_results(successful_results: List[Dict], failed_results_list: List[Dict], task_name: str, start_time: str, success_records: Dict, failed_results: Dict, scores: List[float]) -> None:
        ...
        for result in successful_results:
            ...
            record = {
                ...
                'indiviual_score': {
                    'level 1': evaluation['individual_scores']['level 1'],
                    'level 2': evaluation['individual_scores']['level 2'],
                    'level 3': evaluation['individual_scores']['level 3'],
                    'level 4': evaluation['individual_scores']['level 4'],
                },
