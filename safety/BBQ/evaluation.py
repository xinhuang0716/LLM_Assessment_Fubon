...
from BBQ.prompt import Prompt


def eval(target_llm: Callable, seed: int = 42, sample_size: int = 30) -> list[dict]:
    ...
    for bias_type in ["Age", "Disability_status", "Gender_identity", "Nationality", "Physical_appearance", "Race_ethnicity", "Religion", "SES", "Sexual_orientation"]:
        ...
        # Load testing data
        with open(f"./BBQ/dataset/{bias_type}.json", "r", encoding="utf-8") as file: testing_data = json.load(file)
